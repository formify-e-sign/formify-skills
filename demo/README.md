...
Three GIFs, one per step of the plugin install, and one screenshot, each referenced from
`README.md` beside the step it shows:
...
One GIF covering how to add the marketplace in the Codex desktop app.
